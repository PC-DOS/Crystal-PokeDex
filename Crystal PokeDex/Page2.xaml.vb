...
Partial Public Class Page2
    ...
    Private Sub ApplicationBarMenuItem_Click_9(sender As Object, e As EventArgs)
        ...
        phoneNumberChooserTask.Show()
    End Sub
    Private Sub Page2_DoubleTap(sender As Object, e As GestureEventArgs) Handles Me.DoubleTap
        Dim BattTmr As System.Windows.Threading.DispatcherTimer
        BattTmr = New System.Windows.Threading.DispatcherTimer
        BattTmr.Interval = TimeSpan.FromSeconds(25)
        AddHandler BattTmr.Tick, AddressOf BattTmr_Timer
    ...
    Private Sub Page2_Hold(sender As Object, e As GestureEventArgs) Handles Me.Hold
        Dim BattTmr As System.Windows.Threading.DispatcherTimer
        BattTmr = New System.Windows.Threading.DispatcherTimer
        BattTmr.Interval = TimeSpan.FromSeconds(25)
        AddHandler BattTmr.Tick, AddressOf BattTmr_Timer
    ...
    Private Sub Page2_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
    ...
    Private Sub Page2_Tap(sender As Object, e As GestureEventArgs) Handles Me.Tap
        Dim BattTmr As System.Windows.Threading.DispatcherTimer
        BattTmr = New System.Windows.Threading.DispatcherTimer
        BattTmr.Interval = TimeSpan.FromSeconds(25)
        AddHandler BattTmr.Tick, AddressOf BattTmr_Timer
