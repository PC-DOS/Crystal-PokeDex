Module libMultiStatesProvider
    ...
    End Structure
    Public Structure PokemonStateInfo
    ...
    Public StateInformation(0 To 30) As PokemonStateInfo
    Public SharedStateInformation As New PokemonStateInfo
    Public UniversalLoopCounter As Integer
    Public PokemonTypes As New List(Of String)
    Public Sub GenerateSpecificStateInfo(PokemonNationalDexNumberToQuery As Integer)
        States.Clear()
        InitPokemonTypes()
        If PokemonNationalDexNumberToQuery <= TotalPokemonCountPerVersion.DPT Then
            GenerateSpecificStateInfoPreBW(PokemonNationalDexNumberToQuery)
        ElseIf PokemonNationalDexNumberToQuery <= TotalPokemonCountPerVersion.SM Then
            GenerateSpecificStateInfoBWXYSM(PokemonNationalDexNumberToQuery)
        ElseIf PokemonNationalDexNumberToQuery <= TotalPokemonCountPerVersion.SV Then
            GenerateSpecificStateInfoSSSV(PokemonNationalDexNumberToQuery)
        End If
    End Sub
    Private Sub GenerateSpecificStateInfoPreBW(PokemonNationalDexNumberToQuery As Integer)
        Select Case PokemonNationalDexNumberToQuery
            Case 3
                ...
                With StateInformation(0)
                    ...
                    .Weight = "155.5 kg"
                    .Type = "[草]+[毒]"
                    .ImagePath = "/MultiStatesImages/003/Mega.png"
                ...
                With StateInformation(1)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[草]+[毒]"
                    .ImagePath = "/MultiStatesImages/003/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .ATTACK = 82
                        .DEFEND = 83
                        .HP = 80
            ...
            Case 6
                ...
                With StateInformation(0)
                    ...
                    .Weight = "110.5 kg"
                    .Type = "[火]+[龍]"
                    .ImagePath = "/MultiStatesImages/006/MegaX.png"
                    .IsUniqueDescriptionAvailable = True
                ...
                With StateInformation(1)
                    ...
                    .Weight = "100.5 kg"
                    .Type = "[火]+[飛行]"
                    .ImagePath = "/MultiStatesImages/006/MegaY.png"
                    .IsUniqueDescriptionAvailable = True
                ...
                With StateInformation(2)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[火]+[飛行]"
                    .ImagePath = "/MultiStatesImages/006/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .ATTACK = 84
                        .DEFEND = 78
                        .HP = 78
            ...
            Case 9
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.6 m"
                    .Weight = "101.1 kg"
                    .ImagePath = "/MultiStatesImages/009/Mega.png"
                    .IsUniqueDescriptionAvailable = True
                ...
                With StateInformation(1)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[水]"
                    .ImagePath = "/MultiStatesImages/009/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .ATTACK = 83
                        .DEFEND = 100
                        .HP = 79
            ...
            Case 15
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.4 m"
                    .Weight = "40.5 kg"
                    .ImagePath = "/MultiStatesImages/015/Mega.png"
                    .IsUniqueDescriptionAvailable = True
            ...
            Case 18
                ...
                With StateInformation(0)
                    ...
                    .Weight = "50.5 kg"
                    .Type = "[一般]+[飛行]"
                    .ImagePath = "/MultiStatesImages/018/Mega.png"
                    With .SpeciesStrengthValues
                        .HP = 83
                        .ATTACK = 80
                        .DEFEND = 80
            ...
            Case 19
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/019/Alola.png"
                    With .SpeciesStrengthValues
                        .HP = 30
                        .ATTACK = 56
                        .DEFEND = 35
            ...
            Case 20
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/020/Alola.png"
                    With .SpeciesStrengthValues
                        .HP = 75
                        .ATTACK = 71
                        .DEFEND = 70
            ...
            Case 25
                ...
                With StateInformation(1)
                    ...
                    .ImagePath = "/MultiStatesImages/025/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 35
                        .ATTACK = 55
                        .DEFEND = 40
            ...
            Case 26
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/026/Alola.png"
                    With .SpeciesStrengthValues
                        .HP = 60
                        .ATTACK = 85
                        .DEFEND = 50
            ...
            Case 27
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/027/Alola.png"
                    With .SpeciesStrengthValues
                        .HP = 50
                        .ATTACK = 75
                        .DEFEND = 90
            ...
            Case 28
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/028/Alola.png"
                    With .SpeciesStrengthValues
                        .HP = 75
                        .ATTACK = 100
                        .DEFEND = 120
            ...
            Case 37
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/037/Alola.png"
                    With .SpeciesStrengthValues
                        .HP = 38
                        .ATTACK = 41
                        .DEFEND = 40
            ...
            Case 38
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/038/Alola.png"
                    With .SpeciesStrengthValues
                        .HP = 73
                        .ATTACK = 67
                        .DEFEND = 75
            ...
            Case 50
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/050/Alola.png"
                    With .SpeciesStrengthValues
                        .HP = 10
                        .ATTACK = 55
                        .DEFEND = 30
            ...
            Case 51
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/051/Alola.png"
                    With .SpeciesStrengthValues
                        .HP = 35
                        .ATTACK = 100
                        .DEFEND = 60
            ...
            Case 52
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/052/Alola.png"
                    With .SpeciesStrengthValues
                        .HP = 40
                        .ATTACK = 35
                        .DEFEND = 35
                ...
                With StateInformation(1)
                    ...
                    .ImagePath = "/MultiStatesImages/052/Galar.png"
                    With .SpeciesStrengthValues
                        .HP = 40
                        .ATTACK = 45
                        .DEFEND = 35
                ...
                With StateInformation(2)
                    ...
                    .ImagePath = "/MultiStatesImages/052/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 40
                        .ATTACK = 45
                        .DEFEND = 35
            ...
            Case 53
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/053/Alola.png"
                    .Height = "1.1 m"
                    .Weight = "33.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 65
            ...
            Case 58
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/058/Hisui.png"
                    .Height = "0.8 m"
                    .Weight = "22.7 kg"
                    With .SpeciesStrengthValues
                        .HP = 60
            ...
            Case 59
                ...
                With StateInformation(0)
                    ...
                    .IsUniqueDescriptionAvailable = True
                    .UniqueDescription = ""
                    .ImagePath = "/MultiStatesImages/059/Hisui.png"
                    .Height = "2.0 m"
                    .Weight = "168.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 95
            ...
            Case 65
                ...
                With StateInformation(0)
                    ...
                    .Weight = "48.0 kg"
                    .Type = "[超能力]"
                    .ImagePath = "/MultiStatesImages/065/Mega.png"
                    .IsUniqueDescriptionAvailable = True
            ...
            Case 68
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[格鬥]"
                    .ImagePath = "/MultiStatesImages/068/Gigantamax.png"
                    .IsUniqueDescriptionAvailable = True
            ...
            Case 74
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/074/Alola.png"
                    .Height = "0.4 m"
                    .Weight = "20.3 kg"
                    With .SpeciesStrengthValues
                        .HP = 40
            ...
            Case 75
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/075/Alola.png"
                    .Height = "1.0 m"
                    .Weight = "110.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 55
            ...
            Case 76
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/076/Alola.png"
                    .Height = "1.7 m"
                    .Weight = "316.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 80
            ...
            Case 77
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/077/Galar.png"
                    .Height = "0.8 m"
                    .Weight = "24.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 50
            ...
            Case 78
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/078/Galar.png"
                    .Height = "0.8 m"
                    .Weight = "24.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 65
            ...
            Case 79
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/079/Galar.png"
                    .Height = "1.2 m"
                    .Weight = "36.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 90
            ...
            Case 80
                ...
                With StateInformation(0)
                    ...
                    .Weight = "120.0 kg"
                    .Type = "[水]+[超能力]"
                    .ImagePath = "/MultiStatesImages/080/Mega.png"
                    .IsUniqueDescriptionAvailable = True
                ...
                With StateInformation(1)
                    ...
                    .ImagePath = "/MultiStatesImages/080/Galar.png"
                    .Height = "1.6 m"
                    .Weight = "70.5 kg"
                    With .SpeciesStrengthValues
                        .HP = 95
            ...
            Case 83
                ...
                With StateInformation(1)
                    ...
                    .ImagePath = "/MultiStatesImages/083/Galar.png"
                    .Height = "0.8 m"
                    .Weight = "42.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 52
            ...
            Case 88
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/088/Alola.png"
                    .Height = "0.7 m"
                    .Weight = "42.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 80
            ...
            Case 89
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/089/Alola.png"
                    .Height = "1.0 m"
                    .Weight = "52.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 105
            ...
            Case 94
                ...
                With StateInformation(0)
                    ...
                    .Weight = "40.5 kg"
                    .Type = "[幽靈]+[毒]"
                    .ImagePath = "/MultiStatesImages/094/Mega.png"
                    .IsUniqueDescriptionAvailable = True
                ...
                With StateInformation(1)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[幽靈]+[毒]"
                    .ImagePath = "/MultiStatesImages/094/Gigantamax.png"
                    .IsUniqueDescriptionAvailable = True
            ...
            Case 99
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[水]"
                    .ImagePath = "/MultiStatesImages/099/Gigantamax.png"
                    .IsUniqueDescriptionAvailable = True
            ...
            Case 100
                ...
                With StateInformation(0)
                    ...
                    .Weight = "13.0 kg"
                    .Type = "[電]+[草]"
                    .ImagePath = "/MultiStatesImages/100/Hisui.png"
                    .IsUniqueDescriptionAvailable = True
                    .UniqueDescription = ""
                    With .SpeciesStrengthValues
                        .HP = 40
            ...
            Case 101
                ...
                With StateInformation(1)
                    ...
                    .Weight = "71.0 kg"
                    .Type = "[電]+[草]"
                    .ImagePath = "/MultiStatesImages/101/Hisui.png"
                    .IsUniqueDescriptionAvailable = True
            ...
            Case 103
                ...
                With StateInformation(1)
                    ...
                    .ImagePath = "/MultiStatesImages/103/Alola.png"
                    .Height = "10.9 m"
                    .Weight = "415.6 kg"
                    With .SpeciesStrengthValues
                        .HP = 95
            ...
            Case 105
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/105/Alola.png"
                    .Height = "1.0 m"
                    .Weight = "34.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 60
            ...
            Case 110
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/110/Galar.png"
                    .Height = "3.0 m"
                    .Weight = "16.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 65
            ...
            Case 115
                ...
                With StateInformation(0)
                    ...
                    .Height = "2.2 m"
                    .Weight = "100.0 kg"
                    .ImagePath = "/MultiStatesImages/115/Mega.png"
            ...
            Case 122
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/122/Galar.png"
                    .Height = "1.4 m"
                    .Weight = "56.8 kg"
                    With .SpeciesStrengthValues
                        .HP = 50
            ...
            Case 127
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.7 m"
                    .Weight = "59.0 kg"
                    .ImagePath = "/MultiStatesImages/127/Mega.png"
            ...
            Case 128
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.4 m"
                    .Weight = "115.0 kg"
                    .ImagePath = "/MultiStatesImages/128/PaldeaCombat.png"
                ...
                With StateInformation(1)
                    ...
                    .Height = "1.4 m"
                    .Weight = "85.0 kg"
                    .ImagePath = "/MultiStatesImages/128/PaldeaBlaze.png"
                ...
                With StateInformation(2)
                    ...
                    .Height = "1.4 m"
                    .Weight = "110.0 kg"
                    .ImagePath = "/MultiStatesImages/128/PaldeaAqua.png"
            ...
            Case 130
                ...
                With StateInformation(0)
                    ...
                    .Height = "6.5 m"
                    .Weight = "305.0 kg"
                    .ImagePath = "/MultiStatesImages/130/Mega.png"
            ...
            Case 131
                ...
                With StateInformation(0)
                    ...
                    .Height = "24.0 m以上"
                    .Weight = "<缺數據>"
                    .ImagePath = "/MultiStatesImages/131/Gigantamax.png"
            ...
            Case 133
                ...
                With StateInformation(0)
                    ...
                    .Height = "18.0 m以上"
                    .Weight = "<缺數據>"
                    .ImagePath = "/MultiStatesImages/133/Gigantamax.png"
            ...
            Case 142
                ...
                With StateInformation(0)
                    ...
                    .Weight = "79.0 kg"
                    .Type = "[岩石]+[飛行]"
                    .ImagePath = "/MultiStatesImages/142/Mega.png"
                    With .SpeciesStrengthValues
                        .HP = 80
                        .ATTACK = 135
                        .DEFEND = 85
            ...
            Case 143
                ...
                With StateInformation(0)
                    ...
                    .Height = "35.0 m以上"
                    .Weight = "<缺數據>"
                    .ImagePath = "/MultiStatesImages/143/Gigantamax.png"
            ...
            Case 144
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/144/Galar.png"
                    .Height = "1.7 m"
                    .Weight = "50.9 kg"
                    With .SpeciesStrengthValues
                        .HP = 90
            ...
            Case 145
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/145/Galar.png"
                    .Height = "1.6 m"
                    .Weight = "58.2 kg"
                    With .SpeciesStrengthValues
                        .HP = 90
            ...
            Case 146
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/146/Galar.png"
                    .Height = "2.0 m"
                    .Weight = "66.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 90
            ...
            Case 150
                ...
                With StateInformation(0)
                    ...
                    .Weight = "127.0 kg"
                    .Type = "[超能力]+[格鬥]"
                    .ImagePath = "/MultiStatesImages/150/MegaX.png"
                ...
                With StateInformation(1)
                    ...
                    .Height = "1.5 m"
                    .Weight = "33.0 kg"
                    .ImagePath = "/MultiStatesImages/150/MegaY.png"
            ...
            Case 157
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/157/Hisui.png"
                    .Height = "1.6 m"
                    .Weight = "69.8 kg"
                    With .SpeciesStrengthValues
                        .HP = 73
            ...
            Case 181
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.4 m"
                    .Weight = "61.5 kg"
                    .ImagePath = "/MultiStatesImages/181/Mega.png"
            ...
            Case 194
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/194/Paldea.png"
                    .Height = "0.4 m"
                    .Weight = "11.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 55
            ...
            Case 201
                ...
                For UniversalLoopCounter = 0 To 27
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "5.0 kg"
                        .Type = "[超能]"
                        .ImagePath = "/MultiStatesImages/201/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 48
                            .ATTACK = 72
                            .DEFEND = 48
            ...
            Case 208
                ...
                With StateInformation(0)
                    ...
                    .Height = "10.5 m"
                    .Weight = "740.0 kg"
                    .ImagePath = "/MultiStatesImages/208/Mega.png"
                    With .SpeciesStrengthValues
                        .HP = 75
                        .ATTACK = 125
                        .DEFEND = 230
            ...
            Case 211
                ...
                With StateInformation(1)
                    ...
                    .Height = "0.5 m"
                    .Weight = "3.9 kg"
                    .ImagePath = "/MultiStatesImages/211/Hisui.png"
            ...
            Case 212
                ...
                With StateInformation(0)
                    ...
                    .Height = "2.0 m"
                    .Weight = "125.0 kg"
                    .ImagePath = "/MultiStatesImages/212/Mega.png"
                    .UniqueDescription = ""
                    With .SpeciesStrengthValues
                        .HP = 70
                        .ATTACK = 150
            ...
            Case 214
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.7 m"
                    .Weight = "62.5 kg"
                    .ImagePath = "/MultiStatesImages/214/Mega.png"
            ...
            Case 215
                ...
                With StateInformation(0)
                    ...
                    .Height = "0.5 m"
                    .Weight = "3.9 kg"
                    .ImagePath = "/MultiStatesImages/215/Hisui.png"
            ...
            Case 222
                ...
                With StateInformation(1)
                    ...
                    .Height = "0.6 m"
                    .Weight = "0.5 kg"
                    .ImagePath = "/MultiStatesImages/222/Galar.png"
            ...
            Case 229
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.9 m"
                    .Weight = "49.5 kg"
                    .ImagePath = "/MultiStatesImages/229/Mega.png"
            ...
            Case 248
                ...
                With StateInformation(0)
                    ...
                    .Weight = "255.0 kg"
                    .Type = "[岩石]+[惡]"
                    .ImagePath = "/MultiStatesImages/248/Mega.png"
            ...
            Case 254
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.9 m"
                    .Weight = "55.2 kg"
                    .ImagePath = "/MultiStatesImages/254/Mega.png"
                    With .SpeciesStrengthValues
                        .HP = 70
                        .ATTACK = 110
                        .DEFEND = 75
            ...
            Case 257
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.9 m"
                    .Weight = "52.0 kg"
                    .ImagePath = "/MultiStatesImages/257/Mega.png"
                    With .SpeciesStrengthValues
                        .HP = 80
                        .ATTACK = 160
                        .DEFEND = 80
            ...
            Case 260
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.9 m"
                    .Weight = "102.0 kg"
                    .ImagePath = "/MultiStatesImages/260/Mega.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 150
                        .DEFEND = 110
            ...
            Case 263
                ...
                With StateInformation(0)
                    ...
                    .Height = "0.4 m"
                    .Weight = "17.5 kg"
                    .ImagePath = "/MultiStatesImages/263/Galar.png"
            ...
            Case 264
                ...
                With StateInformation(0)
                    ...
                    .Height = "0.5 m"
                    .Weight = "32.5 kg"
                    .ImagePath = "/MultiStatesImages/264/Galar.png"
            ...
            Case 282
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.6 m"
                    .Weight = "48.4 kg"
                    .ImagePath = "/MultiStatesImages/282/Mega.png"
                    With .SpeciesStrengthValues
                        .HP = 68
                        .ATTACK = 85
                        .DEFEND = 65
            ...
            Case 302
                ...
                With StateInformation(0)
                    ...
                    .Weight = "161.0 kg"
                    .Type = "[惡]+[幽靈]"
                    .ImagePath = "/MultiStatesImages/302/Mega.png"
            ...
            Case 303
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.0 m"
                    .Weight = "23.5 kg"
                    .ImagePath = "/MultiStatesImages/303/Mega.png"
            ...
            Case 306
                ...
                With StateInformation(0)
                    ...
                    .Height = "2.2 m"
                    .Weight = "395.0 kg"
                    .ImagePath = "/MultiStatesImages/306/Mega.png"
                    With .SpeciesStrengthValues
                        .HP = 70
                        .ATTACK = 140
                        .DEFEND = 230
            ...
            Case 308
                ...
                With StateInformation(0)
                    ...
                    .Weight = "31.5 kg"
                    .Type = "[格鬥]+[超能力]"
                    .ImagePath = "/MultiStatesImages/308/Mega.png"
                    With .SpeciesStrengthValues
                        .HP = 60
                        .ATTACK = 100
                        .DEFEND = 85
            ...
            Case 310
                ...
                With StateInformation(0)
                    ...
                    .Weight = "44.0 kg"
                    .Type = "[電]"
                    .ImagePath = "/MultiStatesImages/310/Mega.png"
            ...
            Case 319
                ...
                With StateInformation(0)
                    ...
                    .Height = "2.5 m"
                    .Weight = "130.3 kg"
                    .ImagePath = "/MultiStatesImages/319/Mega.png"
            ...
            Case 323
                ...
                With StateInformation(0)
                    ...
                    .Height = "2.5 m"
                    .Weight = "320.5 kg"
                    .ImagePath = "/MultiStatesImages/323/Mega.png"
                    With .SpeciesStrengthValues
                        .HP = 70
                        .ATTACK = 120
                        .DEFEND = 100
            ...
            Case 334
                ...
                With StateInformation(0)
                    ...
                    .Weight = "20.6 kg"
                    .Type = "[龍]+[妖精]"
                    .ImagePath = "/MultiStatesImages/334/Mega.png"
                    With .SpeciesStrengthValues
                        .HP = 75
                        .ATTACK = 110
                        .DEFEND = 110
            ...
            Case 351
                ...
                With StateInformation(0)
                    ...
                    .Weight = "0.8 kg"
                    .Type = "[火]"
                    .ImagePath = "/MultiStatesImages/351/1.png"
                    With .SpeciesStrengthValues
                        .HP = 70
                        .ATTACK = 70
                        .DEFEND = 70
                ...
                With StateInformation(1)
                    ...
                    .Weight = "0.8 kg"
                    .Type = "[水]"
                    .ImagePath = "/MultiStatesImages/351/2.png"
                    With .SpeciesStrengthValues
                        .HP = 70
                        .ATTACK = 70
                        .DEFEND = 70
                ...
                With StateInformation(2)
                    ...
                    .Weight = "0.8 kg"
                    .Type = "[冰]"
                    .ImagePath = "/MultiStatesImages/351/3.png"
                    With .SpeciesStrengthValues
                        .HP = 70
                        .ATTACK = 70
                        .DEFEND = 70
                ...
                With StateInformation(3)
                    ...
                    .Weight = "0.8 kg"
                    .Type = "[一般]"
                    .ImagePath = "/MultiStatesImages/351/4.png"
                    With .SpeciesStrengthValues
                        .HP = 70
                        .ATTACK = 70
                        .DEFEND = 70
            ...
            Case 354
                ...
                With StateInformation(0)
                    ...
                    .Weight = "13.0 kg"
                    .Type = "[幽靈]"
                    .ImagePath = "/MultiStatesImages/354/Mega.png"
            ...
            Case 359
                ...
                With StateInformation(0)
                    ...
                    .Weight = "49.0 kg"
                    .Type = "[惡]"
                    .ImagePath = "/MultiStatesImages/359/Mega.png"
            ...
            Case 362
                ...
                With StateInformation(0)
                    ...
                    .Height = "2.1 m"
                    .Weight = "350.2 kg"
                    .ImagePath = "/MultiStatesImages/362/Mega.png"
            ...
            Case 373
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.8 m"
                    .Weight = "112.6 kg"
                    .ImagePath = "/MultiStatesImages/373/Mega.png"
            ...
            Case 376
                ...
                With StateInformation(0)
                    ...
                    .Height = "2.5 m"
                    .Weight = "942.9 kg"
                    .ImagePath = "/MultiStatesImages/376/Mega.png"
            ...
            Case 380
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.8 m"
                    .Weight = "52.0 kg"
                    .ImagePath = "/MultiStatesImages/380/Mega.png"
                    With .SpeciesStrengthValues
                        .HP = 80
                        .ATTACK = 100
                        .DEFEND = 120
            ...
            Case 381
                ...
                With StateInformation(0)
                    ...
                    .Height = "2.3 m"
                    .Weight = "70.0 kg"
                    .ImagePath = "/MultiStatesImages/381/Mega.png"
                    With .SpeciesStrengthValues
                        .HP = 80
                        .ATTACK = 130
                        .DEFEND = 100
            ...
            Case 382
                ...
                With StateInformation(0)
                    ...
                    .Height = "9.8 m"
                    .Weight = "430.0 kg"
                    .ImagePath = "/MultiStatesImages/382/Primal.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 150
                        .DEFEND = 90
            ...
            Case 383
                ...
                End With
                With StateInformation(0)
                    .ImagePath = "/MultiStatesImages/383/Primal.png"
                    .Ability1 = 190
                    .Ability2 = "---"
                    .AbilityHidden = "---"
                    .Type = "[地面]+[火]"
            ...
            Case 384
                ...
                End With
                With StateInformation(0)
                    .ImagePath = "/MultiStatesImages/384/Mega.png"
                    .IsUniqueDescriptionAvailable = False
                    .Ability1 = 191
                    .Ability2 = "---"
                    .AbilityHidden = "---"
            ...
            Case 386
                ...
                With StateInformation(0)
                    ...
                    .Weight = "60.8 kg"
                    .Type = "[超能]"
                    .ImagePath = "/MultiStatesImages/386/1.png"
                    With .SpeciesStrengthValues
                        .HP = 50
                        .ATTACK = 150
                        .DEFEND = 50
                ...
                With StateInformation(1)
                    ...
                    .Weight = "60.8 kg"
                    .Type = "[超能]"
                    .ImagePath = "/MultiStatesImages/386/2.png"
                    With .SpeciesStrengthValues
                        .HP = 50
                        .ATTACK = 180
                        .DEFEND = 20
                ...
                With StateInformation(2)
                    ...
                    .Weight = "60.8 kg"
                    .Type = "[超能]"
                    .ImagePath = "/MultiStatesImages/386/3.png"
                    With .SpeciesStrengthValues
                        .HP = 50
                        .ATTACK = 70
                        .DEFEND = 160
                ...
                With StateInformation(3)
                    ...
                    .Weight = "60.8 kg"
                    .Type = "[超能]"
                    .ImagePath = "/MultiStatesImages/386/4.png"
                    With .SpeciesStrengthValues
                        .HP = 50
                        .ATTACK = 95
                        .DEFEND = 90
            ...
            Case 412
                ...
                For UniversalLoopCounter = 0 To 2
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "3.4 kg"
                        .Type = "[蟲]"
                        .ImagePath = "/MultiStatesImages/412/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 40
                            .ATTACK = 29
                            .DEFEND = 45
            ...
            Case 413
                ...
                With StateInformation(0)
                    ...
                    .Weight = "6.5 kg"
                    .Type = "[蟲]+[草]"
                    .ImagePath = "/MultiStatesImages/413/1.png"
                    With .SpeciesStrengthValues
                        .HP = 60
                        .ATTACK = 59
                        .DEFEND = 85
                ...
                With StateInformation(1)
                    ...
                    .Weight = "6.5 kg"
                    .Type = "[蟲]+[地面]"
                    .ImagePath = "/MultiStatesImages/413/2.png"
                    With .SpeciesStrengthValues
                        .HP = 60
                        .ATTACK = 79
                        .DEFEND = 105
                ...
                With StateInformation(2)
                    ...
                    .Weight = "6.5 kg"
                    .Type = "[蟲]+[鋼]"
                    .ImagePath = "/MultiStatesImages/413/3.png"
                    With .SpeciesStrengthValues
                        .HP = 60
                        .ATTACK = 69
                        .DEFEND = 95
            ...
            Case 421
                ...
                For UniversalLoopCounter = 0 To 1
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "9.3 kg"
                        .Type = "[草]"
                        .ImagePath = "/MultiStatesImages/421/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 70
                            .ATTACK = 60
                            .DEFEND = 70
            ...
            Case 422
                ...
                For UniversalLoopCounter = 0 To 1
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "6.3 kg"
                        .Type = "[水]"
                        .ImagePath = "/MultiStatesImages/422/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 76
                            .ATTACK = 48
                            .DEFEND = 48
            ...
            Case 423
                ...
                For UniversalLoopCounter = 0 To 1
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "29.9 kg"
                        .Type = "[水]+[地面]"
                        .ImagePath = "/MultiStatesImages/423/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 111
                            .ATTACK = 83
                            .DEFEND = 68
            ...
            Case 428
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.3 m"
                    .Weight = "28.3 kg"
                    .ImagePath = "/MultiStatesImages/428/Mega.png"
            ...
            Case 445
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.9 m"
                    .Weight = "95.0 kg"
                    .ImagePath = "/MultiStatesImages/445/Mega.png"
            ...
            Case 448
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.3 m"
                    .Weight = "57.5 kg"
                    .ImagePath = "/MultiStatesImages/448/Mega.png"
            ...
            Case 460
                ...
                With StateInformation(0)
                    ...
                    .Height = "2.7 m"
                    .Weight = "185.0 kg"
                    .ImagePath = "/MultiStatesImages/460/Mega.png"
                    With .SpeciesStrengthValues
                        .HP = 90
                        .ATTACK = 132
                        .DEFEND = 105
            ...
            Case 475
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.6 m"
                    .Weight = "56.4 kg"
                    .ImagePath = "/MultiStatesImages/475/Mega.png"
                    With .SpeciesStrengthValues
                        .HP = 68
                        .ATTACK = 165
                        .DEFEND = 95
            ...
            Case 479
                ...
                With StateInformation(0)
                    ...
                    .Weight = "0.3 kg"
                    .Type = "[電]+[火]"
                    .ImagePath = "/MultiStatesImages/479/1.png"
                ...
                With StateInformation(1)
                    ...
                    .Weight = "0.3 kg"
                    .Type = "[電]+[水]"
                    .ImagePath = "/MultiStatesImages/479/2.png"
                ...
                With StateInformation(2)
                    ...
                    .Weight = "0.3 kg"
                    .Type = "[電]+[冰]"
                    .ImagePath = "/MultiStatesImages/479/3.png"
                ...
                With StateInformation(3)
                    ...
                    .Weight = "0.3 kg"
                    .Type = "[電]+[飛行]"
                    .ImagePath = "/MultiStatesImages/479/4.png"
                ...
                With StateInformation(4)
                    ...
                    .Weight = "0.3 kg"
                    .Type = "[電]+[草]"
                    .ImagePath = "/MultiStatesImages/479/5.png"
            ...
            Case 483
                ...
                With StateInformation(0)
                    ...
                    .Weight = "850.0 kg"
                    .Type = "[鋼]+[龍]"
                    .ImagePath = "/MultiStatesImages/483/Origin.png"
            ...
            Case 484
                ...
                With StateInformation(0)
                    ...
                    .Weight = "660.0 kg"
                    .Type = "[水]+[龍]"
                    .ImagePath = "/MultiStatesImages/484/Origin.png"
            ...
            Case 487
                ...
                With StateInformation(0)
                    ...
                    .Weight = "750.0 kg"
                    .Type = "[幽靈]+[龍]"
                    .ImagePath = "/MultiStatesImages/487/1.png"
                    With .SpeciesStrengthValues
                        .HP = 150
                        .ATTACK = 100
                        .DEFEND = 120
                ...
                With StateInformation(1)
                    ...
                    .Weight = "650.0 kg"
                    .Type = "[幽靈]+[龍]"
                    .ImagePath = "/MultiStatesImages/487/2.png"
                    With .SpeciesStrengthValues
                        .HP = 150
                        .ATTACK = 120
                        .DEFEND = 100
            ...
            Case 492
                ...
                With StateInformation(0)
                    ...
                    .Weight = "2.1 kg"
                    .Type = "[草]"
                    .ImagePath = "/MultiStatesImages/492/1.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 100
                        .DEFEND = 100
                ...
                With StateInformation(1)
                    ...
                    .Weight = "5.2 kg"
                    .Type = "[草]+[飛行]"
                    .ImagePath = "/MultiStatesImages/492/2.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 103
                        .DEFEND = 75
            ...
            Case 493
                ...
                For UniversalLoopCounter = 0 To 17
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Height = "3.2 m"
                        .Weight = "320.0 kg"
                        .Type = "[" & PokemonTypes(UniversalLoopCounter) & "]"
                        .ImagePath = "/MultiStatesImages/493/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 120
                            .ATTACK = 120
                            .DEFEND = 120
        ...
        End Select
    End Sub
    Private Sub GenerateSpecificStateInfoBWXYSM(PokemonNationalDexNumberToQuery As Integer)
        Select Case PokemonNationalDexNumberToQuery
            Case 503
                With States
                    .Add("洗翠的樣子")
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/503/Hisui.png"
                    .Height = "1.5 m"
                    .Weight = "58.2 kg"
                    With .SpeciesStrengthValues
                        .HP = 90
            ...
            Case 531
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.5 m"
                    .Weight = "32.0 kg"
                    .ImagePath = "/MultiStatesImages/531/Mega.png"
                    With .SpeciesStrengthValues
                        .HP = 103
                        .ATTACK = 60
                        .DEFEND = 126
            ...
            Case 549
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/549/Hisui.png"
                    .Height = "1.2 m"
                    .Weight = "19.2 kg"
                    With .SpeciesStrengthValues
                        .HP = 70
            ...
            Case 550
                ...
                With StateInformation(0)
                    ...
                    .Weight = "18.0 kg"
                    .Type = "[水]"
                    .ImagePath = "/MultiStatesImages/550/1.png"
                ...
                With StateInformation(1)
                    ...
                    .Weight = "18.0 kg"
                    .Type = "[水]"
                    .ImagePath = "/MultiStatesImages/550/2.png"
                ...
                With StateInformation(2)
                    ...
                    .Weight = "18.0 kg"
                    .Type = "[水]"
                    .ImagePath = "/MultiStatesImages/550/3.png"
            ...
            Case 554
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/554/Galar.png"
                    .Height = "0.7 m"
                    .Weight = "40.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 70
            ...
            Case 555
                ...
                With StateInformation(0)
                    ...
                    .Weight = "92.9 kg"
                    .Type = "[火]"
                    .ImagePath = "/MultiStatesImages/555/1.png"
                    With .SpeciesStrengthValues
                        .HP = 105
                        .ATTACK = 140
                        .DEFEND = 55
                ...
                With StateInformation(1)
                    ...
                    .Weight = "92.9 kg"
                    .Type = "[火]+[超能]"
                    .ImagePath = "/MultiStatesImages/555/2.png"
                    With .SpeciesStrengthValues
                        .HP = 105
                        .ATTACK = 30
                        .DEFEND = 105
                ...
                With StateInformation(2)
                    ...
                    .ImagePath = "/MultiStatesImages/555/Galar1.png"
                    .Height = "1.7 m"
                    .Weight = "120.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 105
                ...
                With StateInformation(3)
                    ...
                    .ImagePath = "/MultiStatesImages/555/Galar2.png"
                    .Height = "1.7 m"
                    .Weight = "120.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 105
            ...
            Case 562
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/562/Galar.png"
                    .Height = "0.5 m"
                    .Weight = "1.5 kg"
                    With .SpeciesStrengthValues
                        .HP = 38
            ...
            Case 569
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/569/Gigantamax.png"
                    .Height = "21.0 m以上"
                    .Weight = "<缺數據>"
                    With .SpeciesStrengthValues
                        .HP = 80
            ...
            Case 570
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/570/Hisui.png"
                    .Height = "0.7 m"
                    .Weight = "12.5 kg"
                    With .SpeciesStrengthValues
                        .HP = 35
            ...
            Case 571
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/571/Hisui.png"
                    .Height = "1.6 m"
                    .Weight = "73.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 55
            ...
            Case 585
                ...
                For UniversalLoopCounter = 0 To 3
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "19.5 kg"
                        .Type = "[草]+[一般]"
                        .ImagePath = "/MultiStatesImages/585/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 60
                            .ATTACK = 60
                            .DEFEND = 50
            ...
            Case 586
                ...
                For UniversalLoopCounter = 0 To 3
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "92.5 kg"
                        .Type = "[草]+[一般]"
                        .ImagePath = "/MultiStatesImages/586/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 80
                            .ATTACK = 100
                            .DEFEND = 70
            ...
            Case 618
                ...
                With StateInformation(0)
                    ...
                    .Weight = "20.5 kg"
                    .Type = "[冰]"
                    .ImagePath = "/MultiStatesImages/618/Galar.png"
            ...
            Case 628
                ...
                With StateInformation(0)
                    ...
                    .Weight = "43.4 kg"
                    .Type = "[超能力]+[飛行]"
                    .ImagePath = "/MultiStatesImages/628/Hisui.png"
            ...
            Case 641
                ...
                With StateInformation(0)
                    ...
                    .Weight = "63.0 kg"
                    .Type = "[飛行]"
                    .ImagePath = "/MultiStatesImages/641/1.png"
                ...
                With StateInformation(1)
                    ...
                    .Weight = "63.0 kg"
                    .Type = "[飛行]"
                    .ImagePath = "/MultiStatesImages/641/2.png"
            ...
            Case 642
                ...
                With StateInformation(0)
                    ...
                    .Weight = "61.0 kg"
                    .Type = "[電]+[飛行]"
                    .ImagePath = "/MultiStatesImages/642/1.png"
                    .UniqueDescription = "引發風暴的寶可夢。傳說由於牠攪拌大氣，季節因此得以循環不息。據吾人考察，近似人類的形態才是假象而非真身。"
                    With .SpeciesStrengthValues
                        .HP = 79
                        .ATTACK = 115
                ...
                With StateInformation(1)
                    ...
                    .Weight = "61.0 kg"
                    .Type = "[電]+[飛行]"
                    .ImagePath = "/MultiStatesImages/642/2.png"
            ...
            Case 643
                ...
                With StateInformation(0)
                    ...
                    .Weight = "330.0 kg"
                    .Type = "[龍]+[火]"
                    .ImagePath = "/MultiStatesImages/643/1.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 120
                        .DEFEND = 100
            ...
            Case 644
                ...
                With StateInformation(0)
                    ...
                    .Weight = "345.0 kg"
                    .Type = "[龍]+[電]"
                    .ImagePath = "/MultiStatesImages/644/1.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 150
                        .DEFEND = 120
            ...
            Case 645
                ...
                With StateInformation(0)
                    ...
                    .Weight = "68.0 kg"
                    .Type = "[地面]+[飛行]"
                    .ImagePath = "/MultiStatesImages/645/1.png"
                ...
                With StateInformation(1)
                    ...
                    .Weight = "68.0 kg"
                    .Type = "[地面]+[飛行]"
                    .ImagePath = "/MultiStatesImages/645/2.png"
            ...
            Case 646
                ...
                With StateInformation(0)
                    ...
                    .Weight = "325.0 kg"
                    .Type = "[龍]+[冰]"
                    .ImagePath = "/MultiStatesImages/646/1.png"
                ...
                With StateInformation(1)
                    ...
                    .Weight = "325.0 kg"
                    .Type = "[龍]+[冰]"
                    .ImagePath = "/MultiStatesImages/646/2.png"
                    .UniqueDescription = "吸收了與自己擁有相同基因的萊希拉姆，因此能使用火與冰的能量。已經看出寶可夢和人類之間的真實世界將會到來，牠試圖去保護這樣的未來。"
                    With .SpeciesStrengthValues
                        .HP = 125
                        .ATTACK = 120
                ...
                With StateInformation(2)
                    ...
                    .Weight = "325.0 kg"
                    .Type = "[龍]+[冰]"
                    .ImagePath = "/MultiStatesImages/646/3.png"
                ...
                With StateInformation(3)
                    ...
                    .Weight = "325.0 kg"
                    .Type = "[龍]+[冰]"
                    .ImagePath = "/MultiStatesImages/646/4.png"
                    .UniqueDescription = "吸收了與自己擁有相同基因的捷克羅姆，因此能使用電與冰的能量。傳說牠是為了保護寶可夢與人類之間那將在未來實現的理想世界而戰鬥。"
                    With .SpeciesStrengthValues
                        .HP = 125
                        .ATTACK = 170
            ...
            Case 647
                ...
                With StateInformation(0)
                    ...
                    .Weight = "48.5 kg"
                    .Type = "[水]+[格鬥]"
                    .ImagePath = "/MultiStatesImages/647/1.png"
                ...
                With StateInformation(1)
                    ...
                    .Weight = "48.5 kg"
                    .Type = "[水]+[格鬥]"
                    .ImagePath = "/MultiStatesImages/647/2.png"
            ...
            Case 648
                ...
                With StateInformation(0)
                    ...
                    .Weight = "6.5 kg"
                    .Type = "[一般]+[超能]"
                    .ImagePath = "/MultiStatesImages/648/1.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 77
                        .DEFEND = 77
                ...
                With StateInformation(1)
                    ...
                    .Weight = "6.5 kg"
                    .Type = "[一般]+[格鬥]"
                    .ImagePath = "/MultiStatesImages/648/2.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 128
                        .DEFEND = 90
            ...
            Case 649
                ...
                For UniversalLoopCounter = 0 To 3
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "82.5 kg"
                        .Type = "[蟲]+[鋼]"
                        .ImagePath = "/MultiStatesImages/649/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 71
                            .ATTACK = 120
                            .DEFEND = 95
            ...
            Case 658
                ...
                With StateInformation(0)
                    ...
                    .Weight = "40.0 kg"
                    .Type = "[水]+[惡]"
                    .ImagePath = "/MultiStatesImages/658/Ash.png"
                    With .SpeciesStrengthValues
                        .HP = 72
                        .ATTACK = 95
                        .DEFEND = 67
            ...
            Case 666
                ...
                For UniversalLoopCounter = 0 To 19
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "17.0 kg"
                        .Type = "[蟲]+[飛行]"
                        .ImagePath = "/MultiStatesImages/666/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 80
                            .ATTACK = 52
                            .DEFEND = 50
            ...
            Case 669
                ...
                For UniversalLoopCounter = 0 To 4
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "0.1 kg"
                        .Type = "[妖精]"
                        .ImagePath = "/MultiStatesImages/669/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 44
                            .ATTACK = 38
                            .DEFEND = 39
            ...
            Case 670
                ...
                For UniversalLoopCounter = 0 To 4
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "0.9 kg"
                        .Type = "[妖精]"
                        .ImagePath = "/MultiStatesImages/670/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 54
                            .ATTACK = 45
                            .DEFEND = 47
                ...
                With StateInformation(5)
                    ...
                    .Weight = "0.9 kg"
                    .Type = "[妖精]"
                    .ImagePath = "/MultiStatesImages/670/6.png"
                    With .SpeciesStrengthValues
                        .HP = 74
                        .ATTACK = 65
                        .DEFEND = 67
            ...
            Case 671
                ...
                For UniversalLoopCounter = 0 To 4
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "10.0 kg"
                        .Type = "[妖精]"
                        .ImagePath = "/MultiStatesImages/671/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 78
                            .ATTACK = 65
                            .DEFEND = 68
            ...
            Case 676
                ...
                For UniversalLoopCounter = 0 To 8
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "28.0 kg"
                        .Type = "[一般]"
                        .ImagePath = "/MultiStatesImages/676/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 75
                            .ATTACK = 80
                            .DEFEND = 60
            ...
            Case 681
                ...
                With StateInformation(0)
                    ...
                    .Weight = "53.0 kg"
                    .Type = "[鋼]+[幽靈]"
                    .ImagePath = "/MultiStatesImages/681/1.png"
                    With .SpeciesStrengthValues
                        .HP = 60
                        .ATTACK = 150
                        .DEFEND = 50
                ...
                With StateInformation(1)
                    ...
                    .Weight = "53.0 kg"
                    .Type = "[鋼]+[幽靈]"
                    .ImagePath = "/MultiStatesImages/681/2.png"
                    With .SpeciesStrengthValues
                        .HP = 60
                        .ATTACK = 50
                        .DEFEND = 150
            ...
            Case 705
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/705/Hisui.png"
                    .Height = "0.7 m"
                    .Weight = "68.5 kg"
                    With .SpeciesStrengthValues
                        .HP = 58
            ...
            Case 706
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/706/Hisui.png"
                    .Height = "1.7 m"
                    .Weight = "334.1 kg"
                    With .SpeciesStrengthValues
                        .HP = 80
            ...
            Case 710
                ...
                With StateInformation(0)
                    ...
                    .Weight = "3.5 kg"
                    .Type = "[草]+[幽靈]"
                    .ImagePath = "/MultiStatesImages/710/1.png"
                    With .SpeciesStrengthValues
                        .HP = 44
                        .ATTACK = 66
                        .DEFEND = 70
                ...
                With StateInformation(1)
                    ...
                    .Weight = "5.0 kg"
                    .Type = "[草]+[幽靈]"
                    .ImagePath = "/MultiStatesImages/710/2.png"
                    With .SpeciesStrengthValues
                        .HP = 49
                        .ATTACK = 66
                        .DEFEND = 70
                ...
                With StateInformation(2)
                    ...
                    .Weight = "7.5 kg"
                    .Type = "[草]+[幽靈]"
                    .ImagePath = "/MultiStatesImages/710/3.png"
                    With .SpeciesStrengthValues
                        .HP = 54
                        .ATTACK = 66
                        .DEFEND = 70
                ...
                With StateInformation(3)
                    ...
                    .Weight = "15.0 kg"
                    .Type = "[草]+[幽靈]"
                    .ImagePath = "/MultiStatesImages/710/4.png"
                    With .SpeciesStrengthValues
                        .HP = 59
                        .ATTACK = 66
                        .DEFEND = 70
            ...
            Case 711
                ...
                With StateInformation(0)
                    ...
                    .Weight = "9.5 kg"
                    .Type = "[草]+[幽靈]"
                    .ImagePath = "/MultiStatesImages/711/1.png"
                    With .SpeciesStrengthValues
                        .HP = 55
                        .ATTACK = 85
                        .DEFEND = 122
                ...
                With StateInformation(1)
                    ...
                    .Weight = "12.5 kg"
                    .Type = "[草]+[幽靈]"
                    .ImagePath = "/MultiStatesImages/711/2.png"
                    With .SpeciesStrengthValues
                        .HP = 65
                        .ATTACK = 90
                        .DEFEND = 122
                ...
                With StateInformation(2)
                    ...
                    .Weight = "14.0 kg"
                    .Type = "[草]+[幽靈]"
                    .ImagePath = "/MultiStatesImages/711/3.png"
                    With .SpeciesStrengthValues
                        .HP = 75
                        .ATTACK = 95
                        .DEFEND = 122
                ...
                With StateInformation(3)
                    ...
                    .Weight = "39.0 kg"
                    .Type = "[草]+[幽靈]"
                    .ImagePath = "/MultiStatesImages/711/4.png"
                    With .SpeciesStrengthValues
                        .HP = 85
                        .ATTACK = 100
                        .DEFEND = 122
            ...
            Case 713
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/713/Hisui.png"
                    .Height = "1.4 m"
                    .Weight = "262.4 kg"
                    With .SpeciesStrengthValues
                        .HP = 95
            ...
            Case 716
                ...
                For UniversalLoopCounter = 0 To 1
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "215.0 kg"
                        .Type = "[妖精]"
                        .ImagePath = "/MultiStatesImages/716/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 126
                            .ATTACK = 131
                            .DEFEND = 95
            ...
            Case 718
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[龍]+[地面]"
                    .ImagePath = "/MultiStatesImages/718/1.png"
                    With .SpeciesStrengthValues
                        .HP = 0
                        .ATTACK = 0
                        .DEFEND = 0
                ...
                With StateInformation(1)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[龍]+[地面]"
                    .ImagePath = "/MultiStatesImages/718/2.png"
                    With .SpeciesStrengthValues
                        .HP = 0
                        .ATTACK = 0
                        .DEFEND = 0
                ...
                With StateInformation(2)
                    ...
                    .Weight = "33.5 kg"
                    .Type = "[龍]+[地面]"
                    .ImagePath = "/MultiStatesImages/718/3.png"
                    With .SpeciesStrengthValues
                        .HP = 54
                        .ATTACK = 100
                        .DEFEND = 71
                ...
                With StateInformation(3)
                    ...
                    .Weight = "305.0 kg"
                    .Type = "[龍]+[地面]"
                    .ImagePath = "/MultiStatesImages/718/4.png"
                    With .SpeciesStrengthValues
                        .HP = 108
                        .ATTACK = 100
                        .DEFEND = 121
                ...
                With StateInformation(4)
                    ...
                    .Weight = "610.0 kg"
                    .Type = "[龍]+[地面]"
                    .ImagePath = "/MultiStatesImages/718/5.png"
                    With .SpeciesStrengthValues
                        .HP = 216
                        .ATTACK = 100
                        .DEFEND = 121
            ...
            Case 719
                ...
                With StateInformation(0)
                    ...
                    .Height = "1.1 m"
                    .Weight = "27.8 kg"
                    .ImagePath = "/MultiStatesImages/719/Mega.png"
                    With .SpeciesStrengthValues
                        .HP = 50
                        .ATTACK = 160
                        .DEFEND = 110
            ...
            Case 720
                ...
                With StateInformation(0)
                    ...
                    .Weight = "9.0 kg"
                    .Type = "[超能]+[幽靈]"
                    .ImagePath = "/MultiStatesImages/720/1.png"
                    With .SpeciesStrengthValues
                        .HP = 80
                        .ATTACK = 110
                        .DEFEND = 60
                ...
                With StateInformation(1)
                    ...
                    .Weight = "490.0 kg"
                    .Type = "[超能]+[惡]"
                    .ImagePath = "/MultiStatesImages/720/2.png"
                    With .SpeciesStrengthValues
                        .HP = 80
                        .ATTACK = 160
                        .DEFEND = 60
            ...
            Case 724
                ...
                With StateInformation(0)
                    ...
                    .ImagePath = "/MultiStatesImages/724/Hisui.png"
                    .Height = "1.6 m"
                    .Weight = "37.0 kg"
                    With .SpeciesStrengthValues
                        .HP = 88
            ...
            Case 741
                ...
                With StateInformation(0)
                    ...
                    .Weight = "3.4 kg"
                    .Type = "[火]+[飛行]"
                    .ImagePath = "/MultiStatesImages/741/1.png"
                    With .SpeciesStrengthValues
                        .HP = 75
                        .ATTACK = 70
                        .DEFEND = 70
                ...
                With StateInformation(1)
                    ...
                    .Weight = "3.4 kg"
                    .Type = "[電]+[飛行]"
                    .ImagePath = "/MultiStatesImages/741/2.png"
                    With .SpeciesStrengthValues
                        .HP = 75
                        .ATTACK = 70
                        .DEFEND = 70
                ...
                With StateInformation(2)
                    ...
                    .Weight = "3.4 kg"
                    .Type = "[超能]+[飛行]"
                    .ImagePath = "/MultiStatesImages/741/3.png"
                    With .SpeciesStrengthValues
                        .HP = 75
                        .ATTACK = 70
                        .DEFEND = 70
                ...
                With StateInformation(3)
                    ...
                    .Weight = "3.4 kg"
                    .Type = "[幽靈]+[飛行]"
                    .ImagePath = "/MultiStatesImages/741/4.png"
                    With .SpeciesStrengthValues
                        .HP = 75
                        .ATTACK = 70
                        .DEFEND = 70
            ...
            Case 745
                ...
                With StateInformation(0)
                    ...
                    .Weight = "25.0 kg"
                    .Type = "[岩石]"
                    .ImagePath = "/MultiStatesImages/745/1.png"
                    With .SpeciesStrengthValues
                        .HP = 75
                        .ATTACK = 115
                        .DEFEND = 65
                ...
                With StateInformation(1)
                    ...
                    .Weight = "25.0 kg"
                    .Type = "[岩石]"
                    .ImagePath = "/MultiStatesImages/745/2.png"
                    With .SpeciesStrengthValues
                        .HP = 85
                        .ATTACK = 115
                        .DEFEND = 75
                ...
                With StateInformation(2)
                    ...
                    .Weight = "25.0 kg"
                    .Type = "[岩石]"
                    .ImagePath = "/MultiStatesImages/745/3.png"
                    With .SpeciesStrengthValues
                        .HP = 75
                        .ATTACK = 117
                        .DEFEND = 65
            ...
            Case 746
                ...
                With StateInformation(0)
                    ...
                    .Weight = "0.3 kg"
                    .Type = "[水]"
                    .ImagePath = "/MultiStatesImages/746/1.png"
                    With .SpeciesStrengthValues
                        .HP = 45
                        .ATTACK = 20
                        .DEFEND = 20
                ...
                With StateInformation(1)
                    ...
                    .Weight = "78.6 kg"
                    .Type = "[水]"
                    .ImagePath = "/MultiStatesImages/746/2.png"
                    With .SpeciesStrengthValues
                        .HP = 45
                        .ATTACK = 140
                        .DEFEND = 130
            ...
            Case 773
                ...
                For UniversalLoopCounter = 0 To 17
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "100.5 kg"
                        .Type = "[" & PokemonTypes(UniversalLoopCounter) & "]"
                        .ImagePath = "/MultiStatesImages/773/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 95
                            .ATTACK = 95
                            .DEFEND = 95
            ...
            Case 774
                ...
                With StateInformation(0)
                    ...
                    .Weight = "40.0 kg"
                    .Type = "[岩石]+[飛行]"
                    .ImagePath = "/MultiStatesImages/774/1.png"
                    With .SpeciesStrengthValues
                        .HP = 60
                        .ATTACK = 60
                        .DEFEND = 100
                ...
                For UniversalLoopCounter = 1 To 7
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "0.3 kg"
                        .Type = "[岩石]+[飛行]"
                        .ImagePath = "/MultiStatesImages/774/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 60
                            .ATTACK = 100
                            .DEFEND = 60
            ...
            Case 778
                ...
                With StateInformation(0)
                    ...
                    .Weight = "0.7 kg"
                    .Type = "[幽靈]+[妖精]"
                    .ImagePath = "/MultiStatesImages/778/1.png"
                    With .SpeciesStrengthValues
                        .HP = 55
                        .ATTACK = 90
                        .DEFEND = 80
                ...
                With StateInformation(1)
                    ...
                    .Weight = "0.7 kg"
                    .Type = "[幽靈]+[妖精]"
                    .ImagePath = "/MultiStatesImages/778/2.png"
                    With .SpeciesStrengthValues
                        .HP = 55
                        .ATTACK = 90
                        .DEFEND = 80
            ...
            Case 791
                ...
                For UniversalLoopCounter = 0 To 1
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "230.0 kg"
                        .Type = "[超能]+[鋼]"
                        .ImagePath = "/MultiStatesImages/791/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 137
                            .ATTACK = 137
                            .DEFEND = 107
            ...
            Case 792
                ...
                For UniversalLoopCounter = 0 To 1
                    With StateInformation(UniversalLoopCounter)
                        ...
                        .Weight = "120.0 kg"
                        .Type = "[超能]+[幽靈]"
                        .ImagePath = "/MultiStatesImages/792/" & (UniversalLoopCounter + 1).ToString & ".png"
                        With .SpeciesStrengthValues
                            .HP = 137
                            .ATTACK = 113
                            .DEFEND = 89
            ...
            Case 800
                ...
                With StateInformation(0)
                    ...
                    .Weight = "230.0 kg"
                    .Type = "[超能]"
                    .ImagePath = "/MultiStatesImages/800/1.png"
                    With .SpeciesStrengthValues
                        .HP = 97
                        .ATTACK = 107
                        .DEFEND = 101
                ...
                With StateInformation(1)
                    ...
                    .Weight = "460.0 kg"
                    .Type = "[超能]+[鋼]"
                    .ImagePath = "/MultiStatesImages/800/2.png"
                    With .SpeciesStrengthValues
                        .HP = 97
                        .ATTACK = 157
                        .DEFEND = 127
                ...
                With StateInformation(2)
                    ...
                    .Weight = "350.0 kg"
                    .Type = "[超能]+[幽靈]"
                    .ImagePath = "/MultiStatesImages/800/3.png"
                    With .SpeciesStrengthValues
                        .HP = 97
                        .ATTACK = 113
                        .DEFEND = 109
                ...
                With StateInformation(3)
                    ...
                    .Weight = "230.0 kg"
                    .Type = "[超能]+[龍]"
                    .ImagePath = "/MultiStatesImages/800/4.png"
                    With .SpeciesStrengthValues
                        .HP = 97
                        .ATTACK = 167
                        .DEFEND = 97
            ...
            Case 801
                ...
                With StateInformation(0)
                    ...
                    .Weight = "80.5 kg"
                    .Type = "[鋼]+[妖精]"
                    .ImagePath = "/MultiStatesImages/801/500YearsAgo.png"
                    With .SpeciesStrengthValues
                        .HP = 80
                        .ATTACK = 95
                        .DEFEND = 115
            ...
            Case 802
                ...
                With StateInformation(0)
                    ...
                    .Weight = "22.2 kg"
                    .Type = "[格鬥]+[幽靈]"
                    .ImagePath = "/MultiStatesImages/802/1.png"
                    With .SpeciesStrengthValues
                        .HP = 90
                        .ATTACK = 125
                        .DEFEND = 80
                ...
                With StateInformation(1)
                    ...
                    .Weight = "22.2 kg"
                    .Type = "[格鬥]+[幽靈]"
                    .ImagePath = "/MultiStatesImages/802/2.png"
                    With .SpeciesStrengthValues
                        .HP = 90
                        .ATTACK = 125
                        .DEFEND = 80
            ...
            Case 809
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[鋼]"
                    .ImagePath = "/MultiStatesImages/809/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 135
                        .ATTACK = 143
                        .DEFEND = 143
        ...
        End Select
    End Sub
    Private Sub GenerateSpecificStateInfoSSSV(PokemonNationalDexNumberToQuery As Integer)
        Select Case PokemonNationalDexNumberToQuery
            Case 812
                With States
                    .Add("超極巨化")
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[草]"
                    .ImagePath = "/MultiStatesImages/812/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 125
                        .DEFEND = 90
            ...
            Case 815
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[火]"
                    .ImagePath = "/MultiStatesImages/815/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 80
                        .ATTACK = 116
                        .DEFEND = 75
            ...
            Case 818
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[水]"
                    .ImagePath = "/MultiStatesImages/818/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 70
                        .ATTACK = 85
                        .DEFEND = 65
            ...
            Case 823
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[飛行]+[鋼]"
                    .ImagePath = "/MultiStatesImages/823/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 98
                        .ATTACK = 87
                        .DEFEND = 105
            ...
            Case 826
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[蟲]+[超能力]"
                    .ImagePath = "/MultiStatesImages/826/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 60
                        .ATTACK = 45
                        .DEFEND = 110
            ...
            Case 834
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[水]+[岩石]"
                    .ImagePath = "/MultiStatesImages/834/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 90
                        .ATTACK = 115
                        .DEFEND = 90
            ...
            Case 839
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[岩石]+[火]"
                    .ImagePath = "/MultiStatesImages/839/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 110
                        .ATTACK = 80
                        .DEFEND = 120
            ...
            Case 841
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[草]+[龍]"
                    .ImagePath = "/MultiStatesImages/841/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 70
                        .ATTACK = 110
                        .DEFEND = 80
            ...
            Case 842
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[草]+[龍]"
                    .ImagePath = "/MultiStatesImages/842/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 110
                        .ATTACK = 85
                        .DEFEND = 80
            ...
            Case 844
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[地面]"
                    .ImagePath = "/MultiStatesImages/844/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 72
                        .ATTACK = 107
                        .DEFEND = 125
            ...
            Case 849
                ...
                With StateInformation(0)
                    ...
                    .Weight = "40.0 kg"
                    .Type = "[電]+[毒]"
                    .ImagePath = "/MultiStatesImages/849/1.png"
                    With .SpeciesStrengthValues
                        .HP = 75
                        .ATTACK = 98
                        .DEFEND = 70
                ...
                With StateInformation(1)
                    ...
                    .Weight = "40.0 kg"
                    .Type = "[電]+[毒]"
                    .ImagePath = "/MultiStatesImages/849/2.png"
                    With .SpeciesStrengthValues
                        .HP = 75
                        .ATTACK = 98
                        .DEFEND = 70
                ...
                With StateInformation(2)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[電]+[毒]"
                    .ImagePath = "/MultiStatesImages/849/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 75
                        .ATTACK = 98
                        .DEFEND = 70
            ...
            Case 851
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[火]+[蟲]"
                    .ImagePath = "/MultiStatesImages/851/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 115
                        .DEFEND = 65
            ...
            Case 858
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[超能力]+[妖精]"
                    .ImagePath = "/MultiStatesImages/858/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 57
                        .ATTACK = 90
                        .DEFEND = 95
            ...
            Case 861
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[惡]+[妖精]"
                    .ImagePath = "/MultiStatesImages/861/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 95
                        .ATTACK = 120
                        .DEFEND = 65
            ...
            Case 869
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[妖精]"
                    .ImagePath = "/MultiStatesImages/869/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 65
                        .ATTACK = 60
                        .DEFEND = 75
            ...
            Case 875
                ...
                With StateInformation(0)
                    ...
                    .Weight = "89.0 kg"
                    .Type = "[冰]"
                    .ImagePath = "/MultiStatesImages/875/1.png"
                    With .SpeciesStrengthValues
                        .HP = 75
                        .ATTACK = 80
                        .DEFEND = 110
                ...
                With StateInformation(1)
                    ...
                    .Weight = "89.0 kg"
                    .Type = "[冰]"
                    .ImagePath = "/MultiStatesImages/875/2.png"
                    With .SpeciesStrengthValues
                        .HP = 75
                        .ATTACK = 80
                        .DEFEND = 70
            ...
            Case 875
                ...
                With StateInformation(0)
                    ...
                    .Weight = "3.0 kg"
                    .Type = "[電]+[惡]"
                    .ImagePath = "/MultiStatesImages/877/1.png"
                    With .SpeciesStrengthValues
                        .HP = 58
                        .ATTACK = 95
                        .DEFEND = 58
                ...
                With StateInformation(1)
                    ...
                    .Weight = "3.0 kg"
                    .Type = "[電]+[惡]"
                    .ImagePath = "/MultiStatesImages/877/2.png"
                    With .SpeciesStrengthValues
                        .HP = 58
                        .ATTACK = 95
                        .DEFEND = 58
            ...
            Case 879
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[鋼]"
                    .ImagePath = "/MultiStatesImages/879/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 122
                        .ATTACK = 130
                        .DEFEND = 69
            ...
            Case 884
                ...
                With StateInformation(0)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[鋼]"
                    .ImagePath = "/MultiStatesImages/884/Gigantamax.png"
                    With .SpeciesStrengthValues
                        .HP = 70
                        .ATTACK = 95
                        .DEFEND = 115
            ...
            Case 888
                ...
                With StateInformation(0)
                    ...
                    .Weight = "110.0 kg"
                    .Type = "[妖精]"
                    .ImagePath = "/MultiStatesImages/888/1.png"
                    With .SpeciesStrengthValues
                        .HP = 92
                        .ATTACK = 120
                        .DEFEND = 115
                ...
                With StateInformation(1)
                    ...
                    .Weight = "355.0 kg"
                    .Type = "[妖精]+[鋼]"
                    .ImagePath = "/MultiStatesImages/888/2.png"
                    With .SpeciesStrengthValues
                        .HP = 92
                        .ATTACK = 150
                        .DEFEND = 115
            ...
            Case 889
                ...
                With StateInformation(0)
                    ...
                    .Weight = "210.0 kg"
                    .Type = "[格鬥]"
                    .ImagePath = "/MultiStatesImages/889/1.png"
                    With .SpeciesStrengthValues
                        .HP = 92
                        .ATTACK = 120
                        .DEFEND = 115
                ...
                With StateInformation(1)
                    ...
                    .Weight = "785.0 kg"
                    .Type = "[格鬥]+[鋼]"
                    .ImagePath = "/MultiStatesImages/889/2.png"
                    With .SpeciesStrengthValues
                        .HP = 92
                        .ATTACK = 120
                        .DEFEND = 140
            ...
            Case 892
                ...
                With StateInformation(0)
                    ...
                    .Weight = "105.0 kg"
                    .Type = "[格鬥]+[惡]"
                    .ImagePath = "/MultiStatesImages/892/1.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 130
                        .DEFEND = 100
                ...
                With StateInformation(1)
                    ...
                    .Weight = "105.0 kg"
                    .Type = "[格鬥]+[水]"
                    .ImagePath = "/MultiStatesImages/892/2.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 130
                        .DEFEND = 100
                ...
                With StateInformation(2)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[格鬥]+[惡]"
                    .ImagePath = "/MultiStatesImages/892/Gigantamax1.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 130
                        .DEFEND = 100
                ...
                With StateInformation(3)
                    ...
                    .Weight = "<缺數據>"
                    .Type = "[格鬥]+[水]"
                    .ImagePath = "/MultiStatesImages/892/Gigantamax2.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 130
                        .DEFEND = 100
            ...
            Case 898
                ...
                With StateInformation(0)
                    ...
                    .Weight = "809.1 kg"
                    .Type = "[超能力]+[冰]"
                    .ImagePath = "/MultiStatesImages/898/IceRider.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 165
                        .DEFEND = 150
                ...
                With StateInformation(1)
                    ...
                    .Weight = "53.6 kg"
                    .Type = "[超能力]+[幽靈]"
                    .ImagePath = "/MultiStatesImages/898/ShadowRider.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 85
                        .DEFEND = 80
            ...
            Case 905
                ...
                With StateInformation(0)
                    ...
                    .Weight = "48.0 kg"
                    .Type = "[妖精]+[飛行]"
                    .ImagePath = "/MultiStatesImages/905/1.png"
                    With .SpeciesStrengthValues
                        .HP = 74
                        .ATTACK = 115
                        .DEFEND = 70
                ...
                With StateInformation(1)
                    ...
                    .Weight = "48.0 kg"
                    .Type = "[妖精]+[飛行]"
                    .ImagePath = "/MultiStatesImages/905/2.png"
                    With .SpeciesStrengthValues
                        .HP = 74
                        .ATTACK = 115
                        .DEFEND = 110
            ...
            Case 916
                ...
                With StateInformation(0)
                    ...
                    .Weight = "120.0 kg"
                    .Type = "[一般]"
                    .ImagePath = "/MultiStatesImages/916/Male.png"
                    With .SpeciesStrengthValues
                        .HP = 110
                        .ATTACK = 100
                        .DEFEND = 75
                ...
                With StateInformation(1)
                    ...
                    .Weight = "120.0 kg"
                    .Type = "[一般]"
                    .ImagePath = "/MultiStatesImages/916/Female.png"
                    With .SpeciesStrengthValues
                        .HP = 115
                        .ATTACK = 90
                        .DEFEND = 70
            ...
            Case 925
                ...
                With StateInformation(0)
                    ...
                    .Weight = "2.3 kg"
                    .Type = "[一般]"
                    .ImagePath = "/MultiStatesImages/925/Three.png"
                    With .SpeciesStrengthValues
                        .HP = 74
                        .ATTACK = 75
                        .DEFEND = 70
                ...
                With StateInformation(1)
                    ...
                    .Weight = "2.8 kg"
                    .Type = "[一般]"
                    .ImagePath = "/MultiStatesImages/925/Four.png"
                    With .SpeciesStrengthValues
                        .HP = 74
                        .ATTACK = 75
                        .DEFEND = 70
            ...
            Case 931
                ...
                With StateInformation(0)
                    ...
                    .Weight = "2.4 kg"
                    .Type = "[一般]+[飛行]"
                    .ImagePath = "/MultiStatesImages/931/Green.png"
                    With .SpeciesStrengthValues
                        .HP = 82
                        .ATTACK = 96
                        .DEFEND = 51
                ...
                With StateInformation(1)
                    ...
                    .Weight = "2.4 kg"
                    .Type = "[一般]+[飛行]"
                    .ImagePath = "/MultiStatesImages/931/Blue.png"
                    With .SpeciesStrengthValues
                        .HP = 82
                        .ATTACK = 96
                        .DEFEND = 51
                ...
                With StateInformation(2)
                    ...
                    .Weight = "2.4 kg"
                    .Type = "[一般]+[飛行]"
                    .ImagePath = "/MultiStatesImages/931/Yellow.png"
                    With .SpeciesStrengthValues
                        .HP = 82
                        .ATTACK = 96
                        .DEFEND = 51
                ...
                With StateInformation(3)
                    ...
                    .Weight = "2.4 kg"
                    .Type = "[一般]+[飛行]"
                    .ImagePath = "/MultiStatesImages/931/White.png"
                    With .SpeciesStrengthValues
                        .HP = 82
                        .ATTACK = 96
                        .DEFEND = 51
            ...
            Case 964
                ...
                With StateInformation(0)
                    ...
                    .Weight = "60.2 kg"
                    .Type = "[水]"
                    .ImagePath = "/MultiStatesImages/964/Zero.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 70
                        .DEFEND = 72
                ...
                With StateInformation(1)
                    ...
                    .Weight = "97.4 kg"
                    .Type = "[水]"
                    .ImagePath = "/MultiStatesImages/964/Hero.png"
                    With .SpeciesStrengthValues
                        .HP = 100
                        .ATTACK = 160
                        .DEFEND = 97
            ...
            Case 978
                ...
                With StateInformation(0)
                    ...
                    .Weight = "8.0 kg"
                    .Type = "[龍]+[水]"
                    .ImagePath = "/MultiStatesImages/978/Curly.png"
                    With .SpeciesStrengthValues
                        .HP = 68
                        .ATTACK = 50
                        .DEFEND = 60
                ...
                With StateInformation(1)
                    ...
                    .Weight = "8.0 kg"
                    .Type = "[龍]+[水]"
                    .ImagePath = "/MultiStatesImages/978/Droopy.png"
                    With .SpeciesStrengthValues
                        .HP = 68
                        .ATTACK = 50
                        .DEFEND = 60
                ...
                With StateInformation(2)
                    ...
                    .Weight = "8.0 kg"
                    .Type = "[龍]+[水]"
                    .ImagePath = "/MultiStatesImages/978/Stretchy.png"
                    With .SpeciesStrengthValues
                        .HP = 68
                        .ATTACK = 50
                        .DEFEND = 60
            ...
            Case 982
                ...
                With StateInformation(0)
                    ...
                    .Weight = "39.2 kg"
                    .Type = "[一般]"
                    .ImagePath = "/MultiStatesImages/982/Seg2.png"
                    With .SpeciesStrengthValues
                        .HP = 125
                        .ATTACK = 100
                        .DEFEND = 80
                ...
                With StateInformation(0)
                    ...
                    .Weight = "47.4 kg"
                    .Type = "[一般]"
                    .ImagePath = "/MultiStatesImages/982/Seg3.png"
                    With .SpeciesStrengthValues
                        .HP = 125
                        .ATTACK = 100
                        .DEFEND = 80
            ...
            Case 999
                ...
                With StateInformation(0)
                    ...
                    .Weight = "5.0 kg"
                    .Type = "[幽靈]"
                    .ImagePath = "/MultiStatesImages/999/Chest.png"
                    With .SpeciesStrengthValues
                        .HP = 45
                        .ATTACK = 30
                        .DEFEND = 70
                ...
                With StateInformation(1)
                    ...
                    .Weight = "0.1 kg"
                    .Type = "[幽靈]"
                    .ImagePath = "/MultiStatesImages/999/Roaming.png"
                    With .SpeciesStrengthValues
                        .HP = 45
                        .ATTACK = 30
                        .DEFEND = 25
